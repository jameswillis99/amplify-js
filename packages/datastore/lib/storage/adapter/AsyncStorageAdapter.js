...
var AsyncStorageAdapter = /** @class */ (function () {
	...
	AsyncStorageAdapter.prototype.getStorenameForModel = function (
		modelConstructor
	) {
	...
	AsyncStorageAdapter.prototype.setUp = function (
		theSchema,
		namespaceResolver,
			...
			return __generator(this, function (_b) {
				switch (_b.label) {
					...
					case 1:
						...
						if (condition && fromDB) {
							predicates =
								predicates_1.ModelPredicateCreator.getPredicates(condition);
					...
					case 5:
						...
						if (!(id === model.id || opType === types_1.OpType.INSERT))
							return [3 /*break*/, 7];
	...
	AsyncStorageAdapter.prototype.load = function (
		namespaceName,
		srcModelName,
		records
	) {
			...
			return __generator(this, function (_e) {
				switch (_e.label) {
					...
					case 6:
						...
						if (!recordItem[getByfield]) return [3 /*break*/, 9];
						return [
							4 /*yield*/,
	...
	AsyncStorageAdapter.prototype.query = function (
		modelConstructor,
		predicate,
		pagination
	) {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
						...
						predicates =
							predicate &&
							predicates_1.ModelPredicateCreator.getPredicates(predicate);
	...
	AsyncStorageAdapter.prototype.idFromPredicate = function (predicates) {
		...
		var idPredicate =
			...
			predicateObjs.find(function (p) {
				return (
					types_1.isPredicateObj(p) && p.field === 'id' && p.operator === 'eq'
				);
			});
		return idPredicate && idPredicate.operand;
	};
	AsyncStorageAdapter.prototype.filterOnPredicate = function (
		storeName,
		predicates
	) {
		return __awaiter(this, void 0, void 0, function () {
					...
					case 1:
						...
						filtered = predicateObjs
							? all.filter(function (m) {
									return util_1.validatePredicate(m, type, predicateObjs);
							  })
							: all;
	...
	AsyncStorageAdapter.prototype.inMemoryPagination = function (
		records,
		pagination
	) {
		if (pagination && records.length > 1) {
			if (pagination.sort) {
				var sortPredicates =
					predicates_1.ModelSortPredicateCreator.getPredicates(pagination.sort);
	...
	AsyncStorageAdapter.prototype.queryOne = function (
		modelConstructor,
		firstOrLast
	) {
	...
	AsyncStorageAdapter.prototype.delete = function (
	 ...
	 * @param deleteQueue
	 */
	AsyncStorageAdapter.prototype.deleteTraverse = function (
		relations,
		models,
		srcModel,
		nameSpace,
				...
				switch (_e.label) {
					...
					case 2:
						...
						index =
							...
							util_1.getIndexFromAssociation(
								this.schema.namespaces[nameSpace].relationships[modelName]
									.indexes,
								rel.associatedWith
							);
					...
					case 0:
						...
						_loop_1 = function (item) {
							...
							var connectedModels = util_1.traverseModel(
								modelConstructor.name,
								this_1.modelInstanceCreator(modelConstructor, item),
								this_1.schema.namespaces[
									this_1.namespaceResolver(modelConstructor)
								],
								this_1.modelInstanceCreator,
								this_1.getModelConstructorByModelName
							);
