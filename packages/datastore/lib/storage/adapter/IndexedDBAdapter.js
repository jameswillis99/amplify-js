...
var IndexedDBAdapter = /** @class */ (function () {
	...
	IndexedDBAdapter.prototype.getStorenameForModel = function (
		modelConstructor
	) {
										...
										return __generator(this, function (_d) {
											switch (_d.label) {
												case 0:
													if (oldVersion === 0) {
														Object.keys(theSchema.namespaces).forEach(function (
															...
															var namespace =
																theSchema.namespaces[namespaceName];
															Object.keys(namespace.models).forEach(function (
																modelName
															) {
																...
																var indexes =
																	_this.schema.namespaces[namespaceName]
												...
												case 2:
													...
													(_a = __values(txn.objectStoreNames)),
														(_b = _a.next());
													_d.label = 3;
												case 3:
												...
												case 8:
													...
													logger.debug(
														count + ' ' + storeName + ' records migrated'
													);
													_d.label = 9;
												case 9:
													_b = _a.next();
												...
												case 14:
													error_2 = _d.sent();
													logger.error(
														'Error migrating IndexedDB data',
														error_2
													);
													txn.abort();
													throw error_2;
				...
				switch (_b.label) {
					...
					case 1:
						...
						tx = this.db.transaction(
							__spread([storeName], Array.from(set.values())),
							'readwrite'
						);
	...
	IndexedDBAdapter.prototype.filterOnPredicate = function (
		storeName,
		predicates
	) {
		return __awaiter(this, void 0, void 0, function () {
