...
var getDefaultAdapter_1 = __importDefault(
	require('./adapter/getDefaultAdapter')
);
...
var StorageClass = /** @class */ (function () {
					...
					case 2:
						...
						result.forEach(function (r) {
							...
							if (opType === types_1.OpType.UPDATE && !syncResponse) {
								updateMutationInput = _this.getUpdateMutationInput(
									model,
									originalElement,
									patchesTuple
								);
							...
							var modelConstructor =
								Object.getPrototypeOf(originalElement).constructor;
	...
	StorageClass.prototype.delete = function (
	...
	StorageClass.prototype.query = function (
		modelConstructor,
		predicate,
		pagination
	) {
	...
	StorageClass.prototype.observe = function (
		modelConstructor,
		predicate,
		skipOwn
	) {
		...
		var _a =
				predicates_1.ModelPredicateCreator.getPredicates(predicate, false) ||
				{},
	...
	StorageClass.prototype.batchSave = function (
		modelConstructor,
		items,
		mutator
	) {
	...
	StorageClass.prototype.getUpdateMutationInput = function (
		model,
		originalElement,
		patchesTuple
	) {
		...
		var fields =
			this.schema.namespaces[namespace].models[modelConstructor.name].fields;
		...
		updatedFields.forEach(function (field) {
			var e_2, _a, e_3, _b;
			var _c;
			var targetName = types_1.isTargetNameAssociation(
				(_c = fields[field]) === null || _c === void 0 ? void 0 : _c.association
			);
			...
			if (!util_1.valuesEqual(source[key], originalElement[key])) {
				...
				try {
					for (
						var compositeKeys_1 = __values(compositeKeys),
							compositeKeys_1_1 = compositeKeys_1.next();
						!compositeKeys_1_1.done;
						compositeKeys_1_1 = compositeKeys_1.next()
					) {
						...
						if (fieldSet.has(key)) {
							try {
								for (
									var fieldSet_1 = ((e_3 = void 0), __values(fieldSet)),
										fieldSet_1_1 = fieldSet_1.next();
									!fieldSet_1_1.done;
									fieldSet_1_1 = fieldSet_1.next()
								) {
					...
					try {
						if (
							compositeKeys_1_1 &&
							!compositeKeys_1_1.done &&
							(_a = compositeKeys_1.return)
						)
							_a.call(compositeKeys_1);
					} finally {
...
var ExclusiveStorage = /** @class */ (function () {
	...
	ExclusiveStorage.prototype.save = function (
		model,
		condition,
		mutator,
		patchesTuple
