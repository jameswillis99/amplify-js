...
var datastoreConnectivity_1 = __importDefault(
	require('./datastoreConnectivity')
);
...
var SyncEngine = /** @class */ (function () {
																	...
																	var ctlSubsSubscription =
																		ctlSubsObservable_1.subscribe({
																			next: function (msg) {
																				if (
																					msg ===
																					subscription_1.CONTROL_MSG.CONNECTED
																				) {
																					resolve();
																				}
																			},
												...
												return __generator(this, function (_b) {
													switch (_b.label) {
														case 0:
															...
															graphQLCondition =
																utils_1.predicateToGraphQLCondition(condition);
															mutationEvent =
	...
	SyncEngine.prototype.disconnectionHandler = function () {
		...
		return function (msg) {
			...
			if (
				pubsub_1.CONTROL_MSG.CONNECTION_CLOSED === msg ||
