...
var MutationEventOutbox = /** @class */ (function () {
							...
							switch (_b.label) {
								case 0:
									mutationEventModelDefinition =
										this.schema.namespaces[util_1.SYNC].models['MutationEvent'];
									predicate =
								...
								case 3:
									...
									if (
										!(
											first.operation === utils_1.TransformerMutationType.CREATE
										)
									)
										return [3 /*break*/, 8];
									if (
	...
	MutationEventOutbox.prototype.syncOutboxVersionsOnDequeue = function (
		storage,
		record,
		head,
		recordOp
				...
				switch (_a.label) {
					case 0:
						...
						(_version = record._version),
							(_lastChangedAt = record._lastChangedAt),
							(_deleted = record._deleted),
							(_incomingData = __rest(record, [
								'_version',
								'_lastChangedAt',
								'_deleted',
							]));
						incomingData = this.removeTimestampFields(
							head.model,
							_incomingData
						);
						...
						(__version = data._version),
							(__lastChangedAt = data._lastChangedAt),
							(__deleted = data._deleted),
							(_outgoingData = __rest(data, [
								'_version',
								'_lastChangedAt',
								'_deleted',
							]));
						outgoingData = this.removeTimestampFields(
							head.model,
							_outgoingData
						);
					...
					case 2:
						...
						return [
							4 /*yield*/,
							Promise.all(
								reconciledMutations.map(function (m) {
									return __awaiter(_this, void 0, void 0, function () {
										return __generator(this, function (_a) {
											switch (_a.label) {
												case 0:
	...
	MutationEventOutbox.prototype.mergeUserFields = function (previous, current) {
		...
		return this.modelInstanceCreator(
			this.MutationEvent,
			__assign(__assign({}, current), { data: data })
		);
	};
	/*
    ...
    */
	MutationEventOutbox.prototype.removeTimestampFields = function (
		model,
		record
	) {
		var _a, _b;
		...
		var modelAttributes =
			(_a = this.schema.namespaces[util_1.USER].models[model].attributes) ===
				null || _a === void 0
				? void 0
				: _a.find(function (attr) {
						return attr.type === 'model';
				  });
		var timestampFieldsMap =
			(_b =
				modelAttributes === null || modelAttributes === void 0
					? void 0
					: modelAttributes.properties) === null || _b === void 0
				? void 0
				: _b.timestamps;
