...
export declare function generateSelectionSet(
...
export declare function predicateToGraphQLFilter(
	predicatesGroup: PredicatesGroup<any>
): GraphQLFilter;
export declare function getUserGroupsFromToken(
	token: {
		[field: string]: any;
	},
	rule: AuthorizationRule
): string[];
export declare function getModelAuthModes({
	authModeStrategy,
	defaultAuthMode,
	modelName,
	schema,
...
export declare function getTokenForCustomAuth(
