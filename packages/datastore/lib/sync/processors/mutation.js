...
var MutationProcessor = /** @class */ (function () {
		...
		Object.values(this.schema.namespaces).forEach(function (namespace) {
			Object.values(namespace.models)
				...
				.forEach(function (model) {
					var _a = __read(
							utils_1.buildGraphQLOperation(namespace, model, 'CREATE'),
							1
						),
						createMutation = _a[0];
					var _b = __read(
							utils_1.buildGraphQLOperation(namespace, model, 'UPDATE'),
							1
						),
						updateMutation = _b[0];
					var _c = __read(
							utils_1.buildGraphQLOperation(namespace, model, 'DELETE'),
							1
						),
						deleteMutation = _c[0];
	...
	MutationProcessor.prototype.resume = function () {
		return __awaiter(this, void 0, void 0, function () {
			var head, namespaceName, _loop_1, this_1, _a, state_1;
			var _this = this;
			return __generator(this, function (_b) {
				switch (_b.label) {
							...
							return __generator(this, function (_b) {
								switch (_b.label) {
									...
									case 1:
										...
										return [
											4 /*yield*/,
											utils_1.getModelAuthModes({
												authModeStrategy: this_1.authModeStrategy,
												defaultAuthMode:
													this_1.amplifyConfig.aws_appsync_authenticationType,
												modelName: model,
									...
									case 2:
										...
										operationAuthModes_1 =
											modelAuthModes[operation.toUpperCase()];
												...
												return __generator(this, function (_a) {
													switch (_a.label) {
														case 0:
															_a.trys.push([0, 2, , 4]);
															logger.debug(
																'Attempting mutation with authMode: ' +
																	operationAuthModes_1[authModeAttempts_1]
															);
															return [
																4 /*yield*/,
																this.jitteredRetry(
														...
														case 1:
															response = _a.sent();
															logger.debug(
																'Mutation sent successfully with authMode: ' +
																	operationAuthModes_1[authModeAttempts_1]
															);
														...
														case 2:
															...
															if (
																authModeAttempts_1 >=
																operationAuthModes_1.length
															) {
																logger.debug(
																	'Mutation failed with authMode: ' +
																		operationAuthModes_1[authModeAttempts_1 - 1]
																);
																throw error_2;
															}
															logger.debug(
									...
									case 3:
										(_a = __read.apply(void 0, [_b.sent(), 3])),
											(result = _a[0]),
											(opName = _a[1]),
											(modelDefinition = _a[2]);
										return [3 /*break*/, 5];
									case 4:
										error_1 = _b.sent();
										if (error_1.message === 'RetryMutation') {
											return [2 /*return*/, 'continue'];
										}
										if (error_1.message === 'Offline') {
											this_1.pause();
											this_1.observer.error(error_1);
					...
					case 4:
						state_1 = _b.sent();
						if (state_1 === 'break') return [3 /*break*/, 5];
						return [3 /*break*/, 1];
					case 5:
						// pauses itself
						this.pause();
										...
										return __generator(this, function (_h) {
											switch (_h.label) {
												...
												case 1:
													...
													attempt = 0;
													opType =
														this.opTypeFromTransformerOperation(operation);
													_h.label = 2;
												case 2:
													_h.trys.push([2, 4, , 20]);
												...
												case 4:
													...
													(_c = error.originalError),
														(_d = (_c === void 0 ? {} : _c).code),
														(code = _d === void 0 ? null : _d);
	...
	MutationProcessor.prototype.createQueryVariables = function (
		...
		var primaryKey =
			this.schema.namespaces[namespaceName].keys[model].primaryKey;
		var queriesTuples = this.typeQuery.get(modelDefinition);
		var _b = __read(
				queriesTuples.find(function (_a) {
					var _b = __read(_a, 1),
		...
		var _c = JSON.parse(data),
			...
			parsedData = __rest(_c, ['_version']);
		// include all the fields that comprise a custom PK if one is specified
		var deleteInput = {};
		if (primaryKey && primaryKey.length) {
			try {
				for (
					var primaryKey_1 = __values(primaryKey),
						primaryKey_1_1 = primaryKey_1.next();
					!primaryKey_1_1.done;
					primaryKey_1_1 = primaryKey_1.next()
				) {
