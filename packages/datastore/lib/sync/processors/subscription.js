...
var SubscriptionProcessor = /** @class */ (function () {
	...
	SubscriptionProcessor.prototype.buildSubscription = function (
		...
		var _b = __read(
				utils_1.buildSubscriptionGraphQLOperation(
					namespace,
					model,
					transformerMutationType,
					isOwner,
	...
	SubscriptionProcessor.prototype.getAuthorizationInfo = function (
		...
		var iamPrivateAuth =
			authMode === api_1.GRAPHQL_AUTH_MODE.AWS_IAM &&
		...
		var validGroup =
			...
			groupAuthRules.find(function (groupAuthRule) {
				...
				var cognitoUserGroups = utils_1.getUserGroupsFromToken(
					cognitoTokenPayload,
					groupAuthRule
				);
				var oidcUserGroups = utils_1.getUserGroupsFromToken(
					oidcTokenPayload,
					groupAuthRule
				);
