...
var SyncProcessor = /** @class */ (function () {
	...
	SyncProcessor.prototype.graphqlFilterFromPredicate = function (model) {
		...
		var predicatesGroup = ModelPredicateCreator.getPredicates(
									...
									switch (_b.label) {
										...
										case 2:
											...
											if (authModeAttempts >= readAuthModes.length) {
												...
												if (
													getClientSideAuthError(error_1) ||
													getForbiddenError(error_1)
												) {
										...
										return __generator(this, function (_a) {
											switch (_a.label) {
												...
												case 3:
													error_2 = _a.sent();
													clientOrForbiddenErrorMessage =
														getClientSideAuthError(error_2) ||
														getForbiddenError(error_2);
