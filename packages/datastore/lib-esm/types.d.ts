...
export declare function isModelAttributeAuth(
	attr: ModelAttribute
...
export declare function isModelAttributeKey(
	attr: ModelAttribute
): attr is ModelAttributeKey;
export declare function isModelAttributePrimaryKey(
	attr: ModelAttribute
): attr is ModelAttributePrimaryKey;
export declare function isModelAttributeCompositeKey(
	attr: ModelAttribute
...
export declare type PersistentModelConstructor<
...
export declare type TypeConstructorMap = Record<
	string,
...
export declare type MutableModel<
...
>;
export declare type GraphQLFilter = Partial<
	| GraphQLField
	| {
			and: GraphQLFilter[];
	  }
...
export declare type ObserveQueryOptions<T extends PersistentModel> = Pick<
...
export declare type ProducerSortPredicate<M extends PersistentModel> = (
...
export declare type SortPredicateExpression<
	M extends PersistentModel,
	FT
> = TypeName<FT> extends keyof MapTypeToOperands<FT>
...
export declare type SortPredicatesGroup<T extends PersistentModel> =
...
export declare type PollOfflineType = {
	enabled: boolean;
	interval: number;
};
export declare type AuthModeStrategyReturn =
	| GRAPHQL_AUTH_MODE
	| GRAPHQL_AUTH_MODE[]
	| undefined
	| null;
...
export declare type AuthModeStrategy = (
...
export declare type ModelAuthModes = Record<
	string,
	{
...
declare type Option1<T extends PersistentModel> = [
...
declare type ConditionProducer<
	T extends PersistentModel,
	A extends Option<T>
> = (
	...args: A
