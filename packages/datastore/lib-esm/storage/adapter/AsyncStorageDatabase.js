...
var AsyncStorageDatabase = /** @class */ (function () {
			...
			return __generator(this, function (_c) {
				switch (_c.label) {
					...
					case 3:
						...
						try {
							for (
								allItemsKeys_1 = __values(allItemsKeys),
									allItemsKeys_1_1 = allItemsKeys_1.next();
								!allItemsKeys_1_1.done;
								allItemsKeys_1_1 = allItemsKeys_1.next()
							) {
			...
			return __generator(this, function (_c) {
				switch (_c.label) {
						...
						(_a = __read(
							firstOrLast === QueryOne.FIRST
								? (function () {
										...
										try {
											for (
												...
												(_b = __read(collection_1_1.value, 2)),
													(id = _b[0]),
													(ulid = _b[1]);
												break;
								...
								: (function () {
										...
										try {
											for (
												var collection_2 = __values(collection),
													collection_2_1 = collection_2.next();
												!collection_2_1.done;
												collection_2_1 = collection_2.next()
											) {
												(_b = __read(collection_2_1.value, 2)),
													(id = _b[0]),
													(ulid = _b[1]);
											...
											try {
												if (
													collection_2_1 &&
													!collection_2_1.done &&
													(_a = collection_2.return)
												)
													_a.call(collection_2);
											} finally {
					...
					case 2:
						itemString = _b;
						result = itemString
							? JSON.parse(itemString) || undefined
							: undefined;
						return [2 /*return*/, result];
				}
			});
			...
			return __generator(this, function (_f) {
				switch (_f.label) {
					case 0:
						...
						try {
							for (
								collection_3 = __values(collection),
									collection_3_1 = collection_3.next();
								!collection_3_1.done;
								collection_3_1 = collection_3.next()
							) {
								(_d = __read(collection_3_1.value, 2)),
									(id = _d[0]),
									(ulid = _d[1]);
								count++;
								if (count <= start) {
	...
	AsyncStorageDatabase.prototype.getKeyForItem = function (
		storeName,
		id,
		ulid
	) {
	...
	AsyncStorageDatabase.prototype.getLegacyKeyForItem = function (
		storeName,
		id
	) {
		return this.getKeyPrefixForStoreItems(storeName) + '::' + id;
	};
	AsyncStorageDatabase.prototype.getKeyPrefixForStoreItems = function (
		storeName
	) {
