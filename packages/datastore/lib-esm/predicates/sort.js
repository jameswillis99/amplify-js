var ModelSortPredicateCreator = /** @class */ (function () {
	...
	ModelSortPredicateCreator.createPredicateBuilder = function (
		modelDefinition
	) {
	...
	ModelSortPredicateCreator.getPredicates = function (
		predicate,
		throwOnInvalid
	) {
	...
	ModelSortPredicateCreator.createFromExisting = function (
		modelDefinition,
		existing
	) {
