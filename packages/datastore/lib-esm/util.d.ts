...
export declare const validatePredicate: <
	T extends Readonly<
		{
			id: string;
		} & Record<string, any>
...
export declare const validatePredicateField: <T>(
	value: T,
	operator:
		| 'ne'
		| 'eq'
...
export declare const isModelConstructor: <
	T extends Readonly<
		{
			id: string;
		} & Record<string, any>
...
>;
export declare function registerNonModelClass(
	clazz: NonModelTypeConstructor<any>
): void;
export declare const isNonModelConstructor: (
	obj: any
) => obj is NonModelTypeConstructor<any>;
export declare const processCompositeKeys: (
	attributes: ModelAttributes
) => Set<string>[];
export declare const establishRelationAndKeys: (
	namespace: SchemaNamespace
) => [RelationshipType, ModelKeys];
export declare const traverseModel: <
	T extends Readonly<
		{
			id: string;
		} & Record<string, any>
...
>(
	...
	>(
		...
		>,
		init: Pick<T_1, Exclude<keyof T_1, 'id' | 'createdAt' | 'updatedAt'>> &
			Partial<ModelInstanceMetadata>
	) => T_1,
...
export declare const getIndexFromAssociation: (
	indexes: string[],
	src: string
) => string;
...
export declare function sortCompareFunction<T extends PersistentModel>(
	sortPredicates: SortPredicatesGroup<T>
): (a: any, b: any) => number;
export declare function valuesEqual(
	valA: any,
	valB: any,
	nullish?: boolean
): boolean;
